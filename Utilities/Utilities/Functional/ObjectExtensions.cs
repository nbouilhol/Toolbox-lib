...
namespace Utilities.Functional
{
    public static class ObjectExtensions
    {
        ...
        public static TInput? ToNullable<TInput>(this TInput a)
            where TInput : struct
        {
            return a;
        }
        ...
        public static Func<TInput, TInput> If<TInput>(Predicate<TInput> evaluator)
            where TInput : class
        {
            return a => { return a != null ? (evaluator(a) ? a : null) : a; };
        }
        ...
        public static Func<TInput, TInput> Unless<TInput>(Predicate<TInput> evaluator)
            where TInput : class
        {
            return a => { return a != null ? (evaluator(a) ? null : a) : a; };
        }
        ...
        public static Func<TInput, TResult> Return<TInput, TResult>(Func<TInput, TResult> evaluator,
            TResult failureValue)
            where TInput : class
        {
            return a => { return a != null ? evaluator(a) : failureValue; };
        }

        public static Func<TResult> Return<TInput, TResult>(this TInput a, Func<TInput, TResult> evaluator,
            TResult failureValue)
            where TInput : class
        {
        ...
        public static Func<TResult> Return<TInput, TResult>(this Func<TInput> fa, Func<TInput, TResult> evaluator,
            TResult failureValue)
            where TInput : class
        {
        ...
        public static Func<TInput, TResult> With<TInput, TResult>(Func<TInput, TResult> evaluator)
            where TInput : class
        {
            return a => { return a != null ? evaluator(a) : default(TResult); };
        }
        ...
        public static Func<TInput1, TResult> SelectMany<TInput1, TInput2, TResult>(Func<TInput1, TInput2> evaluator1,
            Func<TInput1, TInput2, TResult> evaluator2)
            where TInput1 : class
        ...
        public static Func<TResult> SelectMany<TInput1, TInput2, TResult>(this TInput1 a,
            Func<TInput1, TInput2> evaluator1, Func<TInput1, TInput2, TResult> evaluator2)
            where TInput1 : class
            where TInput2 : IComparable<TInput2>
        {
        ...
        public static Func<TResult> SelectMany<TInput1, TInput2, TResult>(this Func<TInput1> fa,
            Func<TInput1, TInput2> evaluator1, Func<TInput1, TInput2, TResult> evaluator2)
            where TInput1 : class
            where TInput2 : IComparable<TInput2>
        {
