...
namespace Utilities.SqlHelpers
{
    ...
    {
        private static readonly Lazy<Dictionary<SqlDbType, Type>> Map =
            new Lazy<Dictionary<SqlDbType, Type>>(() => new Dictionary<SqlDbType, Type>
            {
        ...
        private static readonly Lazy<Dictionary<Type, SqlDbType>> MapInverse =
            new Lazy<Dictionary<Type, SqlDbType>>(() => new Dictionary<Type, SqlDbType>
            {
