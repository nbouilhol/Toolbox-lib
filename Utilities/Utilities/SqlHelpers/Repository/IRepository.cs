...
namespace Utilities.SqlHelpers
{
    ...
    {
        int BulkDelete(string connectionString, string commandText, DataTable dataTable, params SqlParameter[] parameters);

        int BulkUpdate(string connectionString, string commandText, DataTable dataTable, params SqlParameter[] parameters);
        ...
        IList<T> Execute<T>(string connectionString, string commandText, Func<SqlDataReader, IEnumerable<T>> funcMapper, params object[] parameters);

        IList<T> Execute<T>(string connectionString, string commandText, Func<SqlDataReader, T> mapper, params object[] parameters);

        IList<T> ExecuteAndFlatten<T>(string connectionString, string commandText, Func<SqlDataReader, ICollection<T>> mapper, params object[] parameters);

        IEnumerable<T> ExecuteAsStream<T>(string connectionString, string commandText, Func<SqlDataReader, T> funcMapper, params object[] parameters);

        IEnumerable<T> ExecuteAsStream<T>(string connectionString, string commandText, Func<SqlDataReader, T> funcMapper, Action<SqlCommand> funcAddParams);
        ...
        IList<IDictionary<string, object>> ExecuteDictionary(string connectionString, string commandText, params object[] parameters);
        ...
        int ExecuteNonQuery(string connectionString, string commandText, IEnumerable<IEnumerable<SqlParameter>> parameters);

        int ExecuteNonQuery(string connectionString, string commandText, params object[] parameters);

        TResult ExecuteNonQueryWithIdentity<TResult>(string connectionString, string commandText, params object[] parameters);
