...
using Utilities.SqlHelpers;

namespace Utilities.NLog.SqlHelpers.Repository
{
    public static class Query
    {
        private static readonly Lazy<IRepository> Repository = new Lazy<IRepository>(() => new Utilities.SqlHelpers.Repository.Repository((message, exception) => Guard.LogAndThrow(exception)));
